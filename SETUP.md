...
POSTGRES_PASSWORD=your-secure-database-password  # Must match POSTGRES_PASSWORD
...
| `POSTGRES_PASSWORD` | Must match POSTGRES_PASSWORD      | `your-secure-password`               |

### Database Configuration

This project uses external managed PostgreSQL (Zeabur, AWS RDS, Supabase, etc.).

| Variable            | Description                 | Example                                                    |
| ------------------- | --------------------------- | ---------------------------------------------------------- |
| `POSTGRES_HOST`     | Your external database host | `your-db.zeabur.com` or `your-db.region.rds.amazonaws.com` |
| `POSTGRES_USER`     | Database username           | `postgres`                                                 |
| `POSTGRES_DB`       | Database name               | `chat_dev` or `chat_prod`                                  |
| `POSTGRES_PASSWORD` | Database password           | Your secure password                                       |
| `POSTGRES_PORT`     | Database port               | `22463`                                                    |
...
3. Verify `POSTGRES_HOST` is set correctly:
...
# Use your external database credentials (Zeabur, AWS RDS, etc.)
# Or use localhost if running PostgreSQL locally
